...
for i = 1,30 do warn("XenonV2 : "..randomString()) end
_G.randomString = randomString()
local DiscordLib = {}
...
--[[
pcall(function()
	if tonumber(getgenv().Id) == 830217315605282849 then
		if not isfile(getgenv().Id..'.png') then
			writefile(getgenv().Id..'.png', game:HttpGet('https://i.vgy.me/wvdiFs.png'))
		end
	elseif tonumber(getgenv().Id) == 367888565197078528 then
		if not isfile(getgenv().Id..'.png') then
			writefile(getgenv().Id..'.png', game:HttpGet('https://i.vgy.me/JACIKB.png'))
		end
	end
end)
]]
...
--[[if tonumber(getgenv().Id) == 830217315605282849 then
	pfp = getsynasset(getgenv().Id..'.png')
	user = "Androssy"
	tag = "1068"
end
if tonumber(getgenv().Id) == 367888565197078528 then
	pfp = getsynasset(getgenv().Id..'.png')
	user = "x2Swiftz"
	tag = "#9999"
end]]
...
Discord.Name = tostring(_G.randomString)
warn(Discord.Name)
Discord.Parent = game.CoreGui
Discord.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
Discord.Enabled = true

function DiscordLib:ShowUi()
    if Discord.Enabled == true then
        Discord.Enabled = false
    elseif Discord.Enabled == false then
        Discord.Enabled = true
    end
end
